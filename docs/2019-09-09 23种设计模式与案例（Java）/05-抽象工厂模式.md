...
![1588496233659](images/1588496233659.png)

### 【概念】

是一种为访问类提供一个创建一组相关或相互依赖对象的接口，且访问类无须指定所要产品的具体类就能得到同族的不同等级的产品的模式结构（提供一个接口，可以创建一系列相关或相互依赖的对象，而无需指定它们具体的类）。
...
![1588496285038](images/1588496285038.png)
...
![1588497028250](images/1588497028250.png)
